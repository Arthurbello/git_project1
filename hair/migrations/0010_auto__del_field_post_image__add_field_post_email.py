...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'hair_post', 'image')

        # Adding field 'Post.email'
        db.add_column(u'hair_post', 'email',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'hair_post', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'Post.email'
        db.delete_column(u'hair_post', 'email')
