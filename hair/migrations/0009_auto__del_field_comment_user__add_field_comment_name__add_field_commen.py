...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'hair_comment', 'user',
        ...
        db.delete_column(u'hair_comment', 'name')

        # Deleting field 'Comment.email'
        db.delete_column(u'hair_comment', 'email')
